...
describe("SupabasePromptRepository", () => {
  ...
  describe("toggleFavorite", () => {
    it("active le favori d'un prompt", async () => {
      ...
      await repository.toggleFavorite("prompt-123", false);
    ...
    it("désactive le favori d'un prompt", async () => {
      ...
      await repository.toggleFavorite("prompt-123", true);
    ...
    it("gère les erreurs du toggle favorite", async () => {
      ...
      await expect(repository.toggleFavorite("prompt-123", false)).rejects.toThrow(mockError);
    });
  });
